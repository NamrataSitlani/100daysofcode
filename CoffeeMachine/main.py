...
def is_resource_sufficient(order_ingredients):
    """Returns True if order can be made, false if ingredients are sufficient"""
...
def is_transaction_successful(money_received, cost_of_drink):
    """Returns True if payment is accepted, or False if insufficient money"""
...
def make_coffee(drink_name, order_ingredients):
    """Deduct the ingredients from the total resources"""
    for item in order_ingredients:
